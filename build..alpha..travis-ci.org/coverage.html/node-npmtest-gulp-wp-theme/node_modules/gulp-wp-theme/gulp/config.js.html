...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-gulp-wp-theme/node_modules/gulp-wp-theme/gulp/config.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-gulp-wp-theme/node_modules/gulp-wp-theme/gulp/config.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-gulp-wp-theme/node_modules/gulp-wp-theme/gulp/</a> &#187; config.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if(config.dev){
<span class="cstat-no" title="statement not covered" >    config.dev = _.merge(defaultConfigDev, config.dev);</span>
  } else {
    config.dev = defaultConfigDev;
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if(config.prod){
<span class="cstat-no" title="statement not covered" >    config.prod = _.merge(defaultConfigProd, config.prod);</span>
  } else {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if(config.user) {
<span class="cstat-no" title="statement not covered" >    mergedConfig = _.merge(mergedConfig, config.user);</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if(isProductionEnv) {
<span class="cstat-no" title="statement not covered" >    mergedConfig = _.merge(mergedConfig, config.user);</span>
  }
&nbsp;
  return mergedConfig;
